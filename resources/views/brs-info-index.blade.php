            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Generate Infografis BRS</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <form autocomplete="off" method="post" action="/generate-info" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    <label class="form-control-label" for="brsno">Nomor BRS</label>
                                    <input type="text" class="form-control @error('brsno') is-invalid @enderror" value="{{@old('brsno')}}" id="brsno" name="brsno" placeholder="Nomor BRS">
                                    @error('brsno')

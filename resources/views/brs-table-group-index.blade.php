            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Generate Tabel Komoditas Sorted</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <form autocomplete="off" method="post" action="/generate-table-group" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="form-row">
